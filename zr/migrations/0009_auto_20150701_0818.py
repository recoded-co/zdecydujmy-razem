...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='profile',
            name='source',
            field=models.CharField(default=b'inne', max_length=13, verbose_name='Sk\u0105d dowiedzia\u0142 si\u0119 Pan(i) o konsultacjach?', choices=[(b'media', 'Z medi\xf3w'), (b'ulotka_poczta', 'Z ulotki przes\u0142anej poczt\u0105'), (b'facebook', 'Z facebooka'), (b'ulotka_bezp', 'Z bezpo\u015brednio otrzymanej ulotki'), (b'znajomi', 'Od znajomych'), (b'inne', 'Z innego \u017ar\xf3d\u0142a')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='profile',
            name='zipcode',
            field=models.CharField(default=b'-', max_length=6, verbose_name='Kod pocztowy'),
            preserve_default=True,
        ),
    ]
